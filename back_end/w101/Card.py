...
with open("assets/spells/spell_data/storm.json", "r") as f:
    CARD_DATA = json.load(f)   # <-- this becomes a Python list


class CardDef:
    def __init__(self, id, name, school, description, type, pips, effects, accuracy, pvp_level, reshuffle, condition):
...
CARDS_BY_SCHOOL = {}
ALL_CARD_DEFS = []
CARD_PATH = "assets/spells/spell_data/"
